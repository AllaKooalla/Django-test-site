...
class ContactForm(forms.Form):
    ...
    content = forms.CharField(label='Текст', widget=forms.Textarea(attrs={'class': 'form-control', 'autocomplete': "off", "rows": 5}))
...
class UserRegisretForm(UserCreationForm):
...
class NewsForm(forms.ModelForm):
    ...
    def clean_title(self): #метод валидации title
